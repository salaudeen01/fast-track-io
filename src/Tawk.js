...
export class Tawk {
    constructor({ position = 'bottom-right', token}) {
        this.token = token
    ...
    initialise() {
        const target = document.getElementById("fast-track");
        ...
        const buttonContainerText = document.createElement('p')

        buttonContainerText.innerText = 'Fast Track'

        buttonContainer.appendChild(buttonContainerText);
